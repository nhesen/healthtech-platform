...
ALIASES={"hba1c":"HbA1c","hb a1c":"HbA1c","a1c":"HbA1c","glucose":"Glucose","vitamin d":"Vitamin D","hemoglobin":"Hemoglobin","cholesterol":"Total Cholesterol"}
...
def parse_lab(text:str)->dict[str,Any]:
    ...
    return {"results":results,"report_date":None,"source_name":None}
