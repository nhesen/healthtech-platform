...
function Dashboard({session}:{session:Session}){
 ...
 const links=role==="DOCTOR"?[["Patients","/doctor/patients"],["Alerts","/doctor/alerts"],["Consultations","/doctor/consultations"]]:role==="HOSPITAL_ADMIN"?[["Command Center","/admin/command-center"],["Departments","/admin/departments"],["Beds","/admin/beds"],["Patient Flow","/admin/flow"],["Tasks","/admin/tasks"],["Safety","/admin/safety"],["Analytics","/admin/analytics"]]:[["My health","/patient/health"]];
