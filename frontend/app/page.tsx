...
export default function Home(){
 if(!DEMO_MODE)return <main className="min-h-[100dvh] p-10"><div className="mx-auto max-w-xl rounded-2xl border bg-white p-8"><h1 className="text-3xl font-bold">DigiSolution Web Panels</h1><p className="mt-3 text-gray-600">Demo mode is disabled. Configure production authentication to continue.</p></div></main>;
...
function Dashboard({session}:{session:Session}){
 ...
 return <main className="min-h-[100dvh] p-5 md:p-10"><div className="mx-auto max-w-5xl">
  ...
  {role==="PATIENT"?<section className="mb-6 rounded-2xl border border-blue-200 bg-blue-50 p-5"><p className="text-xs font-bold tracking-wider text-primary">PATIENT EXPERIENCE</p><h2 className="mt-2 text-xl font-bold">DigiSolution Patient is a native Expo app</h2><p className="mt-1 text-sm text-gray-600">Start <code>apps/patient-mobile</code>, scan its QR code in Expo Go, and sign in with FIN <code>1AZ0001</code>.</p></section>:null}
